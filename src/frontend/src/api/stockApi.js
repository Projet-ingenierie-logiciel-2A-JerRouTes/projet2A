 ...
 * Correspond à l'endpoint FastAPI : GET /api/stocks/ingredients
 */
export async function getMyIngredients() {
  try {
    console.log("📤 Requête : GET /api/stocks/ingredients");
    
    const res = await API.get("/api/stocks/ingredients");
