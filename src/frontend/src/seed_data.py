...
def get_app_data():
    ...
    ingredients = [ingr_farine, ingr_lait, ingr_oeufs, ingr_sucre, ingr_levure,
                   ingr_beurre, ingr_pates, ingr_riz, ingr_tomates]
    ...
    stock_principal.add_item(2, 502, 2.0, today + timedelta(days=15)) # Lot qui périme dans 15j
    stock_principal.add_item(2, 505, 1.0, today + timedelta(days=5))  # Lot qui périme dans 5j (sera en haut de liste)
